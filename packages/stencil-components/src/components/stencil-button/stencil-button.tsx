...
export class StencilButton {
  ...
  buttonClass() {
    const variantClass = (this.destructive && 'destructive') || (this.primary && 'primary') || (this.secondary && 'secondary');
  ...
  render() {
    ...
    return (
      <button
        ...
        data-analytics-properties={this.analytics && JSON.stringify(this.analytics.properties)}
      >
        {this.renderContent()}
      </button>
    );
